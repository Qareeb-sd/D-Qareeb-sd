...
-- ============================================================
--  توصيل الطرود + السفر بين المدن كخدمتين مستقلّتين (تسعير كامل بالمسافة/الزمن).
-- ============================================================
insert into public.service_pricing
...
-- ============================================================
--  تحصين أمني ومحاسبي (مراجعة الخلفية) — من 2026_07_security_hardening.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
--  تحصين أمني — الجولة الثانية (من 2026_07_security_hardening2.sql)
-- ============================================================
-- ============================================================
...
-- ============================================================
--  تحصين أمني — الجولة الثالثة (من 2026_07_security_hardening3.sql)
-- ============================================================
-- ============================================================
...
-- ============================================================
--  خصوصية الترحيل (من 2026_07_commute_privacy.sql)
-- ============================================================
-- ============================================================
...
-- ============================================================
--  تسعير الترحيل (من 2026_07_commute_pricing.sql)
-- ============================================================
-- ============================================================
...
-- ============================================================
--  صرف الترحيل الشهري تلقائياً (من 2026_07_commute_auto_settle.sql)
-- ============================================================
-- ============================================================
...
-- ============================================================
--  ترحيل يومي: تحوّل تلقائي لكاش/بنك عند نقص الرصيد (من 2026_07_commute_daily_cash_fallback.sql)
-- ============================================================
-- ============================================================
...
-- ============================================================
--  ملخّص أمانات الترحيل المحتجَزة (من 2026_07_commute_held_summary.sql)
-- ============================================================
-- ============================================================
...
-- ============================================================
--  بثّ الإشعارات الجماعي على دفعات (قابلية التوسّع) — 2026_07_broadcast_fanout
-- ============================================================
...
-- ============================================================
--  تصليب قابلية التوسّع — فهارس + توجيه إشعار الطلب للقريبين — 2026_07_scale_hardening
-- ============================================================
...
-- ============================================================
--  إصلاحات جولة الفحص — 2026_07_audit_fixes (مطابقة المركبة/حارس السعر/الرواتب/البرومو/المهلة/VIP)
-- ============================================================
...
-- ============================================================
--  إصلاح دَين الإلغاء — 2026_07_cancellation_debt_fix
-- ============================================================
...
-- ============================================================
--  توحيد صلاحيات الموظفين — 2026_07_staff_perms_align
-- ============================================================
...
-- ============================================================
--  إصلاح الحلقة اللانهائية في سياسات الترحيل — 2026_07_commute_rls_recursion_fix
-- ============================================================
-- ============================================================
