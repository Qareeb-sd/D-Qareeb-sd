...
- رفع إثبات التحويل إلى Supabase Storage (الحقل موجود، ينقص الرفع الفعلي).
- حساب الأجرة بمسافة/زمن فعليين بدل التقدير المبدئي.
- تقسيم الحزمة (code-splitting) لتقليل حجم الـ bundle.
